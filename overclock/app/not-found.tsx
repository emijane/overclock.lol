        ...
        <PageReveal delay={1}>
          <section className="mx-auto w-full max-w-md text-center">
            ...
            <div className="mt-8">
              <Link
                href="/"
                className="inline-flex h-8 items-center rounded-[10px] border border-white/10 bg-white/5 px-3 text-xs font-medium text-zinc-100 backdrop-blur-md transition hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/70 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
              >
                Go home
              </Link>
            </div>
