...
grant execute on function public.is_chat_thread_participant(uuid, uuid) to authenticated;
grant execute on function public.can_read_chat_thread(uuid, uuid) to authenticated;
