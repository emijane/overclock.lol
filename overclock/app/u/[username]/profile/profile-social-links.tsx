...
const BUTTON_ACCENTS = {
  ...
  x: "hover:bg-white/[0.075] hover:shadow-[0_0_24px_var(--profile-rank-glow),inset_0_1px_0_rgba(255,255,255,0.12)]",
  youtube:
    ...
    <div className="relative flex flex-col items-start gap-2 sm:items-end">
      <div className="flex flex-wrap items-center gap-2 sm:justify-end">
        ...
        {links.map((link) => {
          ...
          const buttonClassName = `group inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border text-zinc-200 shadow-[0_0_14px_var(--profile-rank-glow),inset_0_1px_0_rgba(255,255,255,0.08),0_10px_28px_rgba(0,0,0,0.18)] backdrop-blur-md transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/70 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900 ${
            isActive
              ? "border-sky-400/60 bg-sky-400/12 shadow-[0_0_24px_rgba(56,189,248,0.2),inset_0_1px_0_rgba(255,255,255,0.12)]"
              : `bg-white/[0.045] [border-color:var(--profile-rank-border)] ${BUTTON_ACCENTS[link.platform]}`
          }`;
          const icon = (
            <Icon
      ...
      {statusMessage ? (
        <div
          className="inline-flex items-center gap-1.5 rounded-full border bg-white/[0.055] px-2.5 py-1 text-[12px] font-medium tracking-[-0.01em] text-zinc-300 shadow-[0_0_14px_var(--profile-rank-glow),inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-md [border-color:var(--profile-rank-border)]"
          aria-live="polite"
        >
