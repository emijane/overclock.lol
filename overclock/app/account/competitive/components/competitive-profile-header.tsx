    ...
    <header className="py-4 sm:py-5">
      <div className="space-y-2.5">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <Link
            href="/duos/create"
            className="inline-flex h-9 shrink-0 cursor-pointer items-center gap-2 self-start rounded-[10px] border border-white/[0.14] bg-[#262626] px-3.5 text-sm font-semibold text-zinc-100 transition-all duration-200 hover:border-white/[0.2] hover:bg-[#303030] hover:text-white"
          >
