    ...
    <section className="border-t border-white/10 px-5 py-4 sm:px-6 sm:py-5">
      <form action={saveCompetitiveProfileSettings}>
        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
          ...
          <label className="grid gap-1.5 text-sm text-zinc-300 sm:min-w-[14rem]">
            <span className="sr-only">Platform</span>
            <select
              name="platform"
              defaultValue={selectedPlatform ?? ""}
              className="h-10 rounded-2xl border border-white/10 bg-white/[0.035] px-3.5 text-sm text-zinc-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] outline-none transition hover:border-white/20 focus:border-sky-400/60"
            >
