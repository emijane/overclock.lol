  ...
  return (
    <div className="grid gap-5 rounded-3xl border border-slate-800 bg-slate-900/80 p-8">
      ...
      <button
        ...
        disabled
        aria-disabled="true"
        className="flex items-center justify-center gap-3 rounded-full bg-[#5865F2] px-5 py-3 text-sm font-semibold text-white opacity-90 transition"
      >
        <svg
          aria-hidden="true"
          viewBox="0 0 24 24"
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-950/70 p-4 text-sm leading-6 text-slate-400">
        This button is intentionally placeholder-only for the moment. Next we
        can connect it to Supabase OAuth and your Discord application settings.
      </div>
    </div>
  );
}
