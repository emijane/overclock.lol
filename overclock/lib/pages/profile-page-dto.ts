...
import type { CompetitiveProfile, CompetitiveRoleProfile } from "@/lib/competitive/competitive-profile-types";
import {
...
function normalizeDto(value: unknown): ProfilePageDto {
  ...
  return {
    ...
    profile: profileRecord && typeof profileRecord.id === "string" && typeof profileRecord.username === "string"
      ? {
          id: profileRecord.id,
          username: profileRecord.username,
          displayName:
            typeof profileRecord.displayName === "string" ? profileRecord.displayName : null,
          discordUsername:
            typeof profileRecord.discordUsername === "string" ? profileRecord.discordUsername : null,
          discordAvatarUrl:
            typeof profileRecord.discordAvatarUrl === "string" ? profileRecord.discordAvatarUrl : null,
          avatarUrl:
            typeof profileRecord.avatarUrl === "string" ? profileRecord.avatarUrl : null,
          avatarUpdatedAt:
            typeof profileRecord.avatarUpdatedAt === "string" ? profileRecord.avatarUpdatedAt : null,
          coverImagePath:
            typeof profileRecord.coverImagePath === "string" ? profileRecord.coverImagePath : null,
          coverImageUpdatedAt:
            typeof profileRecord.coverImageUpdatedAt === "string" ? profileRecord.coverImageUpdatedAt : null,
          ...
          currentRankTier:
            typeof profileRecord.currentRankTier === "string" ? profileRecord.currentRankTier : null,
          currentRankDivision:
          ...
          lookingFor: Array.isArray(profileRecord.lookingFor)
            ...
            : [],
          battlenetHandle:
            typeof profileRecord.battlenetHandle === "string" ? profileRecord.battlenetHandle : null,
          twitchUrl:
