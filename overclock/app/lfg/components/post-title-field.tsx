...
export function PostTitleField() {
  ...
  return (
    <div className="mt-4">
      <label
        htmlFor={inputId}
        className="mb-3 block text-base font-semibold tracking-[-0.02em] text-zinc-50"
      >
        Create your post
      </label>
      <div className="rounded-[22px] border border-zinc-800 bg-zinc-950/90 px-4 py-3.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
        <input
          ...
          className="h-6 w-full bg-transparent text-[15px] text-zinc-100 outline-none transition placeholder:text-zinc-500"
        />
