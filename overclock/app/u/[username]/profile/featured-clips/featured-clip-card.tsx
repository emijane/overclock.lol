...
export function FeaturedClipCard({
  ...
  return (
    ...
    >
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          {isOwner ? (
            <div className="flex items-center gap-2">
              <span className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-black/25 text-zinc-200">
      ...
      <div className="flex items-center justify-between gap-3 border-t border-zinc-800/80 bg-zinc-950/80 px-4 py-3 text-sm text-zinc-400">
